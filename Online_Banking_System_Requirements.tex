...
\begin{tikzpicture}[
    ...
    boundary/.style={rectangle, draw=bordergray, fill=primaryblue!2, minimum width=8.5cm, minimum height=18cm, thick, rounded corners}
]

    % Draw System Boundary
    \node (sys) [boundary] at (0, -0.2) {};
    \node[anchor=north, font=\normalsize\bfseries, text=primaryblue, yshift=-0.2cm] at (sys.north) {Online Banking System (OBS) Boundary};
